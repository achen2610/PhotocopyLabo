...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="about-company">
        <div class="company-name">
            <h2>GIỚI THIỆU VỀ CÔNG TY TNHH TM & DV NHẤT THIÊN TÂN</h2>
        </div>
        <div class="company-detail">
            <div class="company-detail-title-1">
                <p>I. CÔNG TY</p>
            </div>
            <div class="company-detail-content-1">
                <p>
                    Công ty Nhất Thiên Tân chúng tôi là công ty chuyên về cung cấp, cho thuê, bảo hành, bảo trì, bảo dưỡng và các dịch vụ khác theo yêu cầu của khách hàng về thiết bị máy photocopy của các hãng : <span>Ricoh</span>, Sharp, Canon, Toshiba ... và các thiết bị văn phòng khác.Ngoài ra chúng tôi còn tư vấn về giải pháp hệ thống văn phòng kèm theo thiết bị cho khách hàng thường xuyên.
                </p>
            </div>
            <div class="company-detail-title-2">
                <p>II. LĨNH VỰC KINH DOANH</p>
            </div>
            <div class="company-detail-content-2">
                <div class="node-1">
                    <p>1. Máy văn phòng</p>
                </div>
                ...
                <div class="node-content-2">
                    <p>
                       Sự hài lòng của khách hàng là mong muốn lớn nhất của chúng tôi. Với đội ngũ hùng hậu các kỹ sư và kỹ thuật viên lành nghề luôn sẵn sàng đi bất cứ đâu để phục vụ khách hàng kịp thời và chu đáo. Do đó dù ở các tỉnh vùng sâu, vùng xa, khách hàng của chúng tôi vẫn cảm thấy hài lòng với công tác dịch vụ của Công ty.
                    </p>
                </div>
                <div class="node-3">
