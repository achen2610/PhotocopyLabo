        ...
        <div class="row">
            <div class="col-md-5 col-sm-12">
                ...
                <div class="row tin-lien-quan">
                    <div class="title-tin-lien-quan">
                        <p>TIN LIÊN QUAN</p>
                    </div>
                    <div class="info-tin-lien-quan">
                        <ul>
                            <asp:Repeater runat="server" ID="rptRelatedNews" OnItemCommand="rptRelatedNews_ItemCommand">
                                <ItemTemplate>
                                    <li>
                                        <asp:Label ID="lbRelatedNewsLink" runat="server" Text='<%#Eval("relatedNewsLink") %>' Visible="false"></asp:Label>
                                        <asp:LinkButton runat="server" ID="linkRelatedNews" CommandName="GoLink" CommandArgument="<%#Container.ItemIndex %>"><%#Eval("relatedNewsName") %></asp:LinkButton>
                                        <asp:Label ID="lbTinTucID" runat="server" Visible="false" Text='<%#Eval("tinTucID") %>'></asp:Label>
                                    </li>
                                </ItemTemplate>
                            </asp:Repeater>
                        </ul>
