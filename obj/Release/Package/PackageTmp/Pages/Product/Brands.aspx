<%@ Page Title="" Language="C#" MasterPageFile="~/Template.Master" AutoEventWireup="true" CodeBehind="Brands.aspx.cs" Inherits="Photocopy.Brands" %>
        ...
        <ItemTemplate>
			<div class="col-lg-3 col-md-6 col-sm-12">
				<div class="tile" id="thumbnail" runat="server">
                    <a href='/chi-tiet-san-pham/<%#Eval("SanPhamID") %>'><img class="img-responsive" src='\Images\<%#Eval("HinhAnh") %>' alt="<%#Eval("TenSanPham") %>" style="width:250px;height:221px;"></a>
					<%--<asp:LinkButton ID="LinkImgToDetail1" runat="server" CommandName="GetProductDetail1"><img class="img-responsive" src='\Images\<%#Eval("HinhAnh") %>' alt="<%#Eval("TenSanPham") %>" style="width:250px;height:221px;"></asp:LinkButton>--%>
					<div class="footer">
						...
						<div class="price-label"><%#Eval("DonGia","{0:0,000}").Replace(",",".") %> VNĐ</div>
						<div class="tools">
							<div>
