<%@ Page Title="" Language="C#" MasterPageFile="~/TemplateAdmin.Master" AutoEventWireup="true" ValidateRequest="false" CodeBehind="AddNews.aspx.cs" Inherits="Photocopy.AddNews" %>
        ...
        <div class="add-news-content">
            ...
            <div class="content-html row">
                ...
                <div class="content-html-input col-lg-9">
                    ...
                    <asp:TextBox ID="txHtml" runat="server" TextMode="MultiLine" CssClass="form-control" onkeyup="document.getElementById('preview').innerHTML = this.value"></asp:TextBox>--%>
                </div>
            </div>
            ...
            <div class="content-quote row">
                ...
                <div class="content-quote-input col-lg-4">
